"""
Local version of API views without Celery dependencies
"""
import logging
...
class DocumentViewSet(viewsets.ModelViewSet):
    ...
    def reprocess(self, request, pk=None):
        ...
        # Process synchronously for local development
        try:
            process_document_sync(str(document.id))
            return Response({'message': 'Document reprocessed successfully'})
        except Exception as e:
            return Response(
                {'error': f'Document reprocessing failed: {str(e)}'},
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                # Document will be marked as failed in the task
